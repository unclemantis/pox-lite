...
(define-map deposits { height: uint } { deposit-id: int, address: principal, amount: uint, memo: (optional (string-utf8 80)) })
(define-map boosts { boost-id: int } { height: uint, address: principal, amount: uint })

(define-public (deposit (amount uint) (address principal) (memo (string-utf8 80)) (height uint))
  (begin
