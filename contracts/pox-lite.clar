...
(define-map deposits { block-height: uint } (list 100 { address: (optional principal), amount: uint, low: uint, high: uint, memo: (buff 70)}))
...
(define-public (append-deposit (amount (optional uint)) (memo (buff 70)) (height uint))
